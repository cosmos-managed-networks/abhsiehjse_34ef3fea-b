...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.abhsiehjse" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.abhsiehjse" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.abhsiehjse"}")
export BINARY=${BINARY:-newabhishekndjwf}
...
from_scratch () {
  ...
  # 0x8c9213b5c130a38f04def13bd48bab4cdc457221efd63aw40lxf3n4mhf7dzhjkr453axuraqrgj4
  ...
  # 0x8c9213b5c130a38f04def13bd48bab4cdc457221hj5fveer5cjtn4wd6wstzugjfdxzl0xpp5svmu
